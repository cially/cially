...
export interface PbAddNewDataOptions {
  guildID: string;
  data: ScrapedMessage[];
}

export async function pbAddNewData({ guildID, data }: PbAddNewDataOptions): Promise<any> {
  ...
  async function bulkAddition(messages: ScrapedMessage[], guildRecord: any) {
