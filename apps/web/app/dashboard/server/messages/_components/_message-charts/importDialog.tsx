...
export default function ImportDialogCard({ guildID, isGuest }) {
  if (!isGuest) {
                ...
                <AlertDialogContent className="bg-white/5 backdrop-blur-2xl rounded-lg border border-white/10">
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription className="text-gray-400">
                      This action will erase all the message data of your
                      server. Once done so, it will start scraping every single
                      channel the bot has access to and save message log of up
                      to 4 weeks.
                      <br />
                      <br />
                      Please proceed once you've made sure that nothing can
                      cause a downtime to your bot. Also make sure to enable
                      debugging if you want to see details regarding the
                      scraping procedure
                      <br />
                      <br />
                      While Cially is respecting Discord's TOS regarding API
                      requests, if Discord decides to ratelimit your bot for any
                      reason, the procedure will stop automatically. We advise
                      you to not re-run the scrape if done so, and wait for 24
                      hours first
                      <br />
                      <br />
                      If there is an ongoing scrape going on, clicking the
                      button below won't do anything. Restart your bot if you
